# Kubernetes Dashboard: Epic Breakdown
...
### EPIC-01: Kubernetes Resource

- Goal: make Kubernetes Resource measurable and actionable across cost, resilience, performance, scalability, security, disaster-recovery, operational-excellence.
