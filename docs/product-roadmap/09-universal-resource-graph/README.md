...
- `feature-backlog.csv` contains 1,715 implementation-ready feature rows with release phase, ship size, API contract, tests, rollout guardrail, and runbook scope.
