...
pub fn configure(cfg: &mut web::ServiceConfig, db: Arc<DatabaseConnection>) {
    ...
    let scope = web::scope("/api/kubernetes")
        .route(
            "/test-db-connection",
            web::get().to(kube_controller::test_db_connection_controller),
        )
        .route(
            "/clusters",
        ...
        .route(
            ...
            web::get().to(kube_controller::get_cluster_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/namespaces/pillars",
            web::get().to(kube_controller::get_namespace_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/nodes/pillars",
            web::get().to(kube_controller::get_node_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/nodetaints/pillars",
            web::get().to(kube_controller::get_node_taint_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/node-taints/pillars",
            web::get().to(kube_controller::get_node_taint_inventory_pillar_reports_controller),
        )
        .route(
        ...
        .route(
            "/inventory/podlogs/pillars",
            web::get().to(kube_controller::get_pod_log_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/pod-logs/pillars",
            web::get().to(kube_controller::get_pod_log_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/podexec/pillars",
            web::get().to(kube_controller::get_pod_exec_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/pod-exec/pillars",
            web::get().to(kube_controller::get_pod_exec_inventory_pillar_reports_controller),
        )
        .route(
        ...
        .route(
            "/inventory/replicasets/pillars",
            web::get().to(kube_controller::get_replicaset_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/statefulsets/pillars",
            web::get().to(kube_controller::get_statefulset_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/daemonsets/pillars",
            web::get().to(kube_controller::get_daemonset_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/jobs/pillars",
            web::get().to(kube_controller::get_job_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/cronjobs/pillars",
        ...
        .route(
            "/inventory/ingresses/pillars",
            web::get().to(kube_controller::get_ingress_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/gateway-api/pillars",
        ...
        .route(
            "/inventory/endpointslices/pillars",
            web::get().to(kube_controller::get_endpoint_slice_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/configmaps/pillars",
        ...
        .route(
            "/inventory/serviceaccounts/pillars",
            web::get().to(kube_controller::get_service_account_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/roles/pillars",
            web::get().to(kube_controller::get_role_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/rolebindings/pillars",
        ...
        .route(
            "/inventory/clusterrolebindings/pillars",
            web::get()
                .to(kube_controller::get_cluster_role_binding_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/networkpolicies/pillars",
            web::get().to(kube_controller::get_network_policy_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/hpa/pillars",
            web::get().to(kube_controller::get_hpa_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/horizontalpodautoscalers/pillars",
            web::get().to(kube_controller::get_hpa_inventory_pillar_reports_controller),
        )
        .route(
        ...
        .route(
            "/inventory/pdb/pillars",
            web::get().to(kube_controller::get_pdb_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/poddisruptionbudgets/pillars",
            web::get().to(kube_controller::get_pdb_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/resourcequotas/pillars",
            web::get().to(kube_controller::get_resource_quota_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/resource-quotas/pillars",
            web::get().to(kube_controller::get_resource_quota_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/limitranges/pillars",
            web::get().to(kube_controller::get_limit_range_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/limit-ranges/pillars",
            web::get().to(kube_controller::get_limit_range_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/persistentvolumes/pillars",
            web::get()
                .to(kube_controller::get_persistent_volume_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/persistent-volumes/pillars",
            web::get()
                .to(kube_controller::get_persistent_volume_inventory_pillar_reports_controller),
        )
        .route(
        ...
        .route(
            "/inventory/volumesnapshots/pillars",
            web::get().to(kube_controller::get_volume_snapshot_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/volume-snapshots/pillars",
            web::get().to(kube_controller::get_volume_snapshot_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/customresourcedefinitions/pillars",
            web::get()
                .to(kube_controller::get_custom_resource_definition_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/custom-resource-definitions/pillars",
            web::get()
                .to(kube_controller::get_custom_resource_definition_inventory_pillar_reports_controller),
        )
        .route(
        ...
        .route(
            "/inventory/custom-resources/pillars",
            web::get().to(kube_controller::get_custom_resource_inventory_pillar_reports_controller),
        )
        .route(
            "/inventory/events/pillars",
            web::get().to(kube_controller::get_event_inventory_pillar_reports_controller),
        )
        .route(
            "/clusters/{cluster_id}",
        ...
        .route(
            "/clusters/{cluster_id}",
            web::put().to(kube_controller::update_cluster_controller),
        )
        .route(
            "/clusters/{cluster_id}",
        ...
        .route(
            "/clusters/{cluster_id}/namespaces",
            web::post().to(kube_controller::create_namespace_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}",
            web::get().to(kube_controller::get_namespace_details_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}",
            web::delete().to(kube_controller::delete_namespace_controller),
        )
        .route(
            "/clusters/{cluster_id}/nodes",
            web::get().to(kube_controller::list_nodes_controller),
        )
        .route(
            "/clusters/{cluster_id}/nodes/{node_name}",
            web::get().to(kube_controller::get_node_details_controller),
        )
        // Route for all deployments in a cluster (new)
        .route(
            "/clusters/{cluster_id}/deployments",
            web::get().to(kube_controller::list_all_deployments_controller),
        )
        // Route for deployments in a specific namespace
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/deployments",
            web::get().to(kube_controller::list_deployments_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/deployments/{deployment_name}",
            web::get().to(kube_controller::get_deployment_details_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/deployments/{deployment_name}:scale",
            web::post().to(kube_controller::scale_deployment_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/deployments/{deployment_name}:restart",
            web::post().to(kube_controller::restart_deployment_controller),
        )
        .route(
        ...
        .route(
            ...
            web::get().to(kube_controller::list_all_stateful_sets_controller),
        )
        // Route for stateful sets in a specific namespace
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/statefulsets",
            web::get().to(kube_controller::list_stateful_sets_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/statefulsets/{stateful_set_name}",
            web::get().to(kube_controller::get_stateful_set_details_controller),
        )
        .route(
        ...
        .route(
            ...
            web::get().to(kube_controller::list_all_services_controller),
        )
        // Route for services in a specific namespace
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/services",
            web::get().to(kube_controller::list_services_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/services/{service_name}",
            web::get().to(kube_controller::get_service_details_controller),
        )
        // Route for all daemon sets in a cluster
        .route(
            "/clusters/{cluster_id}/daemonsets",
            web::get().to(kube_controller::list_all_daemon_sets_controller),
        )
        // Route for daemon sets in a specific namespace
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/daemonsets",
            web::get().to(kube_controller::list_daemon_sets_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/daemonsets/{daemon_set_name}",
            web::get().to(kube_controller::get_daemon_set_details_controller),
        )
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/daemonsets/{daemon_set_name}/pods",
            web::get().to(kube_controller::get_pods_for_daemon_set_controller),
        )
        // Route for all PVCs in a cluster
        .route(
            "/clusters/{cluster_id}/persistentvolumeclaims",
            web::get().to(kube_controller::list_all_pvcs_controller),
        )
        // Route for PVCs in a specific namespace
        .route(
            "/clusters/{cluster_id}/namespaces/{namespace_name}/persistentvolumeclaims",
            web::get().to(kube_controller::list_pvcs_controller),
        )
        .route(
        ...
        .route(
            "/clusters/{cluster_id}/persistentvolumes/{pv_name}",
